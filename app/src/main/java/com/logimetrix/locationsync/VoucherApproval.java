...
public class VoucherApproval extends AppCompatActivity {

    private RecyclerView recyclerView;
    ProgressBar progressBar;
    private LinearLayoutManager linearLayoutManager;
    public VoucherApprovalAdapter voucherApprovalAdapter;
    ImageView imgBack;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_voucher_approval);
    ...
    private void fetchVoucherList(String token) {
        progressBar.setVisibility(View.VISIBLE);
        APIInterface apiInterface = APIClient.getClient().create(APIInterface.class);
        Call<ExpenseVoucherListModel> call = apiInterface.expenseVoucherList(token);
        call.enqueue(new Callback<ExpenseVoucherListModel>() {
            ...
            public void onResponse(Call<ExpenseVoucherListModel> call, Response<ExpenseVoucherListModel> response) {
                if (response.isSuccessful()){
                    ...
                    if (response.body().getFlag()){
                        ...
                        voucherApprovalAdapter = new VoucherApprovalAdapter(getApplicationContext(),expenseArrayList);
                        recyclerView.setAdapter(voucherApprovalAdapter);
            ...
            public void onFailure(Call<ExpenseVoucherListModel> call, Throwable t) {
                progressBar.setVisibility(View.GONE);
                Toast.makeText(VoucherApproval.this, "Connection Error! Please try again.", Toast.LENGTH_SHORT).show();
            }
        });
